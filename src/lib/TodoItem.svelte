...
<ui5-li-custom data-key={datakey} selected={item.done || undefined}>
	<div class="li-content">
		...
		<div class="li-content-actions">
			<ui5-button class="edit-btn" on:click={handleEditPress} aria-hidden="true">Edit</ui5-button>
			<ui5-button design="Negative" on:click={handleDeletePress} aria-hidden="true">Delete</ui5-button>
		</div>
	</div>
</ui5-li-custom>
